...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = "/laboratorio/API/usuario/guardar"
        const config = {
            method: 'POST',
            body
        }
...
const buscar = async () => {
    try {
        const url = "/laboratorio/API/usuario/buscar"
        const config = {
            method: 'GET',
        }
...
const traerDatos = (usuario) => {
    ...
    formulario.usu_password.value = usuario.nombre
    formulario.usu_password2.value = usuario.usu_password2
...
const modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario)
        const url = "/laboratorio/API/usuario/modificar"
        const config = {
            method: 'POST',
            body
        }
...
const eliminar = async (usuario) => {
    ...
    if (confirmacion.isConfirmed) {
        try {
            ...
            const url = "/laboratorio/API/usuario/eliminar"
            const config = {
                method: 'POST',
                body
            }
